...
// --- LOGO BASE64 ---
// PEGA AQUÍ EL CÓDIGO BASE64 DE TU LOGO EN FORMATO PNG
...
function downloadPDF() {
    ...
    let finalY = 0;
    let pageNumber = 1;
    const appUrl = "https://chemworks.github.io/LineCalculation/";
    ...
    const addHeaderFooter = () => {
        try {
            // CORRECCIÓN: Se cambió 'SVG' por 'PNG'. Debes usar un PNG para que funcione.
        ...
        doc.textWithLink("Online version: " + appUrl, margin, pageHeight - 20, { url: appUrl });
